                ...
                {ROLE_LIST.map((roleObj) => {
                  ...
                  return (
                    <tr key={roleObj.name} className={`hover:bg-[#F9F9F8] transition-colors ${roleObj.name === 'View Only (Dashboard & Reports)' ? 'bg-amber-50/40' : ''}`}>
                      ...
                      <td className="py-4 px-3">{renderPermBadge(perms.dashboard)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.inventory)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.assignments)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.maintenance)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.reports)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.users)}</td>
                      <td className="py-4 px-3">{renderPermBadge(perms.settings)}</td>
